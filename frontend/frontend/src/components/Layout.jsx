...
export default function Layout({ children }) {
  ...
  return (
    <div className="app-shell flex h-screen min-h-0 overflow-hidden bg-[#05070b] text-slate-100">
      <aside
      ...
      >
        <div className={`relative flex min-h-[84px] items-center ${sidebarCollapsed ? 'justify-center px-3' : 'px-5'} py-4`}>
          ...
          <button
            ...
            className="absolute -right-3 top-1/2 z-40 flex h-7 w-7 -translate-y-1/2 items-center justify-center rounded-full border border-white/10 bg-[#111722] text-white/60 shadow-[0_8px_22px_rgba(0,0,0,0.45)] transition hover:border-white/20 hover:bg-[#172130] hover:text-white"
          >
                  ...
                  {settingsItems.map((item) => (
                    <NavLink
                      ...
                      className={({ isActive }) => `group flex items-center rounded-xl py-2 text-sm transition ${sidebarCollapsed ? 'justify-center px-2' : 'gap-2.5 px-3'} ${
                        isActive
                          ? 'border border-[#2f6ac8]/35 bg-[#14233d] text-white shadow-[0_10px_28px_rgba(0,0,0,0.28)]'
