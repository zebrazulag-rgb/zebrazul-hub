...
export default function PreviousStageImportBanner({
  ...
  if (!sourceAvailable) {
    return (
      <div className="surface-card flex items-start gap-3 border border-amber-400/20 bg-amber-400/[0.06] px-5 py-4">
        <Sparkles size={19} className="mt-0.5 shrink-0 text-amber-400" />
        <div>
          <p className="text-sm font-semibold text-[var(--zh-text)]">Preencha primeiro a etapa anterior</p>
  ...
  return (
    <div className="surface-card overflow-hidden border border-blue-400/20 bg-blue-500/[0.055]">
        ...
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              <p className="text-sm font-semibold text-[var(--zh-text)]">{updateAvailable ? 'Há novas informações na etapa anterior' : imported ? 'Etapa conectada à anterior' : 'Preencher com a etapa anterior'}</p>
