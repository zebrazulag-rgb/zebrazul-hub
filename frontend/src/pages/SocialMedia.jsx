...
import { Grid3x3, Instagram, MessageCircle } from 'lucide-react';
import { useAuth } from '../context/AuthContext.jsx';
import Feed from './Feed.jsx';
import StoryHub from './StoryHub.jsx';
import InstagramMessages from './InstagramMessages.jsx';
...
const SECTIONS = {
  ...
  messages: {
    label: 'Mensagens',
    description: 'Caixa de entrada e respostas do Instagram profissional.',
    icon: MessageCircle,
    path: '/social-media/mensagens',
    permission: 'social.messages',
  },
};
...
export default function SocialMedia({ section = 'feed' }) {
  ...
  return (
    <div className="space-y-5">
      ...
      {section === 'messages' && <InstagramMessages />}
    </div>
  );
}
